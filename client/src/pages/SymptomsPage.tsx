...
export default function SymptomsPage() {
  ...
  const handleClear = () => { setSymptoms([]); setInputValue(''); setPatientAge(''); setPatientGender(''); setResult(null); setError(''); setSaved(false); inputRef.current?.focus(); };
    ...
    <div style={{ maxWidth: '900px' }}>
      ...
      <div style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '20px', padding: '28px', marginBottom: '24px', backdropFilter: 'blur(16px)' }}>
        ...
        <p style={{ color: 'rgba(255,255,255,0.35)', fontSize: '12px', marginTop: '6px' }}>
          Press <kbd style={{ background: 'rgba(255,255,255,0.08)', padding: '1px 5px', borderRadius: '4px', color: 'rgba(255,255,255,0.5)' }}>Enter</kbd> after each symptom
        </p>
      ...
      {result && !isLoading && (
        <div ref={resultRef} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '16px' }}>
            ...
            <div style={{ background: 'linear-gradient(135deg, rgba(99,102,241,0.12), rgba(139,92,246,0.08))', border: '1px solid rgba(99,102,241,0.25)', borderRadius: '16px', padding: '20px' }}>
              <div style={{ color: 'rgba(165,180,252,0.7)', fontSize: '12px', fontWeight: 500, marginBottom: '8px', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Likely Diagnosis</div>
